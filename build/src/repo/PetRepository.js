...
var HavenRepository_1 = __importDefault(require("./HavenRepository"));
var PetRepository = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        pet = _a.sent();
                        if (!pet)
                            throw new ErrorHandlers_1.NotFound("Pet not found");
                        return [2 /*return*/, pet];
                }
            });
        });
    ...
    PetRepository.prototype.getAdopted = function (petId, adopterId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.find(petId)];
                    case 1:
                        pet = _a.sent();
                        if (!pet)
                            throw new ErrorHandlers_1.NotFound("Pet not found");
    ...
    PetRepository.prototype.bindHaven = function (petId, havenId) {
        return __awaiter(this, void 0, void 0, function () {
            var pet, haven;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!pet)
                            throw new ErrorHandlers_1.NotFound("Pet not found");
                        return [4 /*yield*/, new HavenRepository_1.default().find(havenId)];
                    case 2:
                        haven = _a.sent();
                        if (!haven)
                            throw new ErrorHandlers_1.NotFound("Adopter not found");
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, { success: true, message: "Pet(" + pet.name + ") has been placed in " + pet.haven.name }];
                }
            });
        });
    };
    PetRepository.prototype.findPetsBySize = function (size) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.find({ where: { size: size } })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    PetRepository.prototype.findPeyByAnyfield = function (campo, value) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                return [2 /*return*/, this.repository.find({ where: (_a = {}, _a[campo] = value, _a) })];
            });
        });
    };
